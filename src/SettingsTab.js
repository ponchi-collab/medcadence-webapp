...
// Generate all 15-minute interval times for 24 hours
    ...
    <div>
      ...
      {subscribed && medicines.length > 0 && (
        <div>
          ...
          <p style={{ fontSize:"12px", color:THEME.textLight, fontWeight:"600", marginBottom:"12px" }}>
            Reminders are sent every 15 minutes. Pick the closest time that works for you.
          </p>
